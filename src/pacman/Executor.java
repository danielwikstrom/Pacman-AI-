...
import pacman.entries.pacman.MyPacManFuzzy;
import pacman.entries.pacman.MyPacManFuzzyGenetic;
import pacman.entries.pacman.MyPacManQLearning;
...
{	
	...
	public static void main(String[] args)
	{
		...
		MyPacManFuzzyGenetic pacman = new MyPacManFuzzyGenetic();
		//RandomPacMan pacman = new RandomPacMan();
		//MyPacManQLearning pacman = new MyPacManQLearning();
		
		exec.runExperiment(pacman,new StarterGhosts(),numTrials);
		//pacman.notLearning();
...
//		exec.runGameTimed(new HumanController(new KeyBoardInput()),new StarterGhosts(),visual);	
    ...
    public void runExperiment(Controller<MOVE> pacManController,Controller<EnumMap<GHOST,MOVE>> ghostController,int trials)
    {
		...
		for(int i=0;i<trials;i++)
		{
			...
			if(i%100==0)
			{
				System.out.println(i+ "\t"+(int)(avgScore/100));
		...
		System.out.println((int)(avgScore/trials));
    }
	
    
    
    
    public float runQuietExperiment(Controller<MOVE> pacManController,Controller<EnumMap<GHOST,MOVE>> ghostController,int trials)
    {
    	double avgScore=0;
